...
This adds ``base_url`` as a universally-accepted keyword argument to constructors of all clients, and provides a more explicit method of specifying the default base URL for any given client class.

It also deprecates a classmethod in OAuthTokenClient, which cannot be used outside of the commercial AWS partition, in favor of the more flexible instance methods.
